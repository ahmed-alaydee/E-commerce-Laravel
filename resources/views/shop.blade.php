            ...
            <div class="img-wrapper">
                ...
                <div class="cart-wrap">
                    <ul>
                        ...
                        <li>
               <a href="javascript:void(0)" 
   onclick="addProductToWishlist({{ $product->id }}, '{{ addslashes($product->name) }}', 1, {{ $product->ruglar_price }})" 
   class="wishlist">
    <!-- محتوى الرابط هنا -->
    <i data-feather="heart"></i>
            ...
            <div class="product-details">
                <div class="rating-details">
                    <span class="font-light grid-content">{{ $product->category->name ?? 'بدون تصنيف' }}</span>
                ...
                <div class="main-price">
                    ...
                    <div class="listing-content">
                        <span class="font-light">{{ $product->category->name ?? 'بدون تصنيف' }}</span>
                        <p class="font-light">${{ $product->shot_description ?? 'وصف غير متوفر' }}.</p>
                    </div>

                    <h3 class="theme-color">{{ $product->ruglar_price ?? '0.00' }}</h3>
...
@endforeach
                      ...
                      {{$products->links("pagination.defult")}}
...
{{--  this function euse jQuery and  js   --}}
