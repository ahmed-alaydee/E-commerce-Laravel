                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    @if ($product->sale_price)
                                     ...
                                     <del>{{ $product->ruglar_price }}</del>
                                     <span>  {{round(( ($product->ruglar_price - $product->sale_price)/ $product->ruglar_price) * 100) }}  % off</span>
                                    @else
                                        {{ $product->ruglar_price }}
                                    @endif
                                    ...
                                    <div class="mt-2 mt-md-3 border-product">
                                        <h6 class="product-title hurry-title d-block">
                                         @if ($product->stock_status == 'instok')
                                              InStock
                                         @else 
                                         out of stock
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        ...
                                        <div class="listing-content">
                                            ...
                                            <p class="font-light">{{ $product->shot_description }}</p>
                                        </div>
