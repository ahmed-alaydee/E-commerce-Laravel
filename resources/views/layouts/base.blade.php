...
<head>
    ...
    <title>Ecommerce_Lavravel_(Ahmed-samir)</title>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{route('app.index')}}" class="text-dainger  fs-4">
                                    Store
                                    </a>
                                </div>
                                        ...
                                        <div class="onhover-div profile-dropdown">
                                            <ul>
                                                ...
                                                @if (Route::has('login'))
                                                  ...
                                                  <li>
                                                    <a href="{{route('logout')}}" 
                                                    onclick="event.preventDefault(); document.getElementById('frmlogo').submit();"
                                                     class="d-block"> Logout</a>
                                                    <form id="frmlogo" action="{{route('logout')}}" method="POST">
                                                    @csrf
                                                    </form>
                                                </li> 
                                                @else
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> 01006082709 </span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Nasr City
                                            India</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> ahmedalayde86@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
