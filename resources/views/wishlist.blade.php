...
@section('content')
    ...
    <section class="wish-list-section section-b-space">
        ...
        @if ($items->count() > 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="mobile-cart-content row">
                                        ...
                                        <div class="col">
                                            <p class="fw-bold">${{ $item->model->ruglar_price }}</p>
                                        </div>
                                        <div class="col">
                                            <h2 class="td-color">
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="javascript:void(0)" class="icon s" >
                                        <i class="fas fa-shopping-cart"></i>
                                    </a>
                                    @endif  --}}
            ...
            <h5 class="mt-3 w-50">Add item to it now.</h5>
            <a href="{{ route('shop.index') }}" class="btn btn-warning mt-3 border-red-500 "> Shop Now</a>
            </div>
        @endif
        </div>
    </section>
    ...
    <form id="movetocart" action="{{ route('wishlist.move.cart') }}" method="POST">
