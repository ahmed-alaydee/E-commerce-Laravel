...
// راوت خاص بالكارت كونتروولر 


Auth::routes();

Route::middleware('auth')->group(function(){
    Route::get('/my-account',[UseController::class,'index'])->name('users.index');
    ...
    Route::get('/wishlist', [WishlistController::class, 'getwishlistProduct'])->name('wishlist.list');
    ...
    Route::post('/wishlist/move-to-cart', [WishlistController::class, 'movecart'])->name('wishlist.move.cart');
});
